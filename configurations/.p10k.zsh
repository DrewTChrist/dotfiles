# Generated by Powerlevel10k configuration wizard on 2021-01-01 at 23:02 MST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 32912.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# slanted separators, sharp heads, slanted tails, 2 lines, disconnected, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND='yellow'
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='black'

  typeset -g POWERLEVEL9K_HISTORY_BACKGROUND='black'
  typeset -g POWERLEVEL9K_HISTORY_FOREGROUND='yellow'
  ...
  typeset -g POWERLEVEL9K_BATTERY_FOREGROUND='yellow'
